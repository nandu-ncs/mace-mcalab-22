...
public class PriorityQueueMain {
    ...
    public static void main(String args[]) {
        ...
        // Creating Priority queue constructor having initial capacity=5 and a
        // StudentComparator instance as its parameters

        PriorityQueue<Student> pq = new PriorityQueue<Student>(5, new StudentComparator());

        // Invoking a parameterized Student constructor with name and cgpa as the
        // elements of queue
        ...
        // Printing names of students in priority order,poll() method is used to access
